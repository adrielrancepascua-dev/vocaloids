                      ...
                      <div className="flex items-center gap-3">
                        {song.slug ? (
                          <Link
                            href={`/song/${song.slug}`}
                            data-cursor="record"
                            className="text-lg md:text-2xl font-bold text-zinc-100 uppercase tracking-wider hover:text-[var(--primary-color)] transition-colors underline-offset-4 hover:underline focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[var(--primary-color)]"
                          >
                            {song.title}
                          </Link>
                        ) : (
